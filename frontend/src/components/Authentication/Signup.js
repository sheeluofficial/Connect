...
const {setIsAuth} = useContext(ChatContext);
         ...
         <form className={classes.form}>
           ...
           >
             <Grid item>
               <FormControlLabel
                 control={<Checkbox />}
                 label="I Accept The Connect App Terms & Conditions"
             ...
             <Grid item>
               <FormControlLabel
                 control={<Checkbox />}
                 label="I Accept The  Connect App Terms Of Use"
                 className={classes.checkbox}
               />
             </Grid>
           </Grid>
           ...
           >
             I acknowledge Connect App will use my information in accordance with
             its
